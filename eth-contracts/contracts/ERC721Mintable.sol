...
// In real projects, I suggest using 'openzeppelin-solidity/contracts/lifecycle/Pausable.sol' instead of re-implementing it!
...
contract ERC721 is Pausable, ERC165 {
  ...
  function approve(address to, uint256 tokenId) public {
    ...
    require(msg.sender == owner || isApprovedForAll(owner, msg.sender), 
      "message sender needs to be the owner of the contract or approve for all needs to be enabled");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
  ...
  // Create private mapping of tokenIds to token URIs called '_tokenURIs'
...
contract NipaHutERC721Token is ERC721Metadata("Nipa Hut Token", "NHT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
